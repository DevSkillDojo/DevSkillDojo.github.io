...
## Introduction
GitHub is a commercial hosting service for software development and version control using Git. It offers the distributed version control and source code management (SCM) functionality of Git, plus its own features.
