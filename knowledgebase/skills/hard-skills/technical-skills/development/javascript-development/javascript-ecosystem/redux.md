...
## Identification:
Short name: Redux
Fully Qualified Name: Development : JavaScript Development : JS Ecosystem : Redux
...
### Hard Prerequisites
Before you begin learning Redux, it is essential that you already have the following skills. For each of the prerequisites, a required proficiency level is defined
...
Like most skills, Redux is not used in isolation, but with other skills in your toolbox. If you build proficiency in these complementary skills, you are likely to be more successful at using Redux in a real-world setting.
...
- TODO
- Single Immutable State Tree (https://egghead.io/courses/getting-started-with-redux)
- Actions
- Reducer Function
- Create Store
- Key Store Methods: getState, dispatch, subscribe
