...
### Alternative skills
There are many ways to skin a cat (or so I've heard). These alternative skills may sometimes allow you to achieve similar outcomes as with JSON. To become a true master at JSON, it would be wise to understand the alternatives as well.
